$("document").ready(function () {
    ...
    form.addEventListener("submit", (e) => {
        ...
        const getWeatherData = async () => {
            ...
            await fetch('https://api.openweathermap.org/data/2.5/weather?q=' + locValue + '&units=metric&appid=2828837120a8df72a7a5962d1eff34cd')
        ...
        const weatherImages = {
            "Clear sky": '<img src="https://cdn-icons-png.flaticon.com/512/3222/3222800.png">',
